...
public:
    ...
    static bool readNifti(std::string inputFilename, ImageType::Pointer outputPointer);
    static bool readVTK(vtkAlgorithmOutput* input, ImageType::Pointer outputPointer);
